			...
			<div class="row">
				...
				<div class="col-sm-6 border border-danger">
					...
					<form action="UsersRegisterServlet" method="post">
						...
						<div class="form-group">
							<label for="pwd">Nhập lại mật khẩu</label> <input name="user-passwordcf"
								placeholder="Nhập lại mật khẩu *" type="password" required
								 class="form-control" id="pwds">
						...
						<div class="form-group">
							<label for="pwd">Tên Người dùng</label> <input name="user-showname"
								placeholder="Tên hiển thị *" type="text" required
								 class="form-control" id="pwdss">
						</div>
						<button type="submit" class="btn btn-danger  text-center">Đăng ký</button>
					</form>
				</div>
			</div>
		</div>
