...
public class SercurtyFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse resp, FilterChain filterChain)
		...
		boolean isAdmin = request.getRequestURI().startsWith("/admin/lib/");
		...
		if (url.indexOf("/viewroot") > 0 || url.indexOf("/admin/lib/") > 0) {
			filterChain.doFilter(request, response);
		}

		String[] listpath = { "/Home", "/HomeProductsServlet", "/blog.jsp", "/contact.jsp", "/login.jsp", "/view-bill.jsp", "/forgot_password.jsp",
				"/ChangePasswordServlet", "/otp_code.jsp", "/change_password.jsp", "/Components/alert_message.jsp",
		...
		String[] listPathAdmin = { "/Admin", "/AdminAddCategory", "/AdminAddDetailProduct", "/AdminAddProducts",
				"/AdminDeleteCategory", "/AdminDeleteDetailProduct", "/AdminDeleteProducts", "/AdminDeleteUser",
				"/AdminEditCategory", "/AdminEditDetailProduct", "/AdminEditDisplayNameUser", "/AdminEditNoteBill",
				"/AdminEditPasswordUser", "/AdminEditProducts", "/AdminEditStatusBill", "/AdminListBills",
				"/AdminListBillsDetail", "/AdminListBillsDetroy", "/AdminListBillsPayment", "/AdminListCategory",
				"/AdminListDetailProduct", "/AdminListProducts", "/AdminListUser", "/AdminProfileUser",
				"/AdminThongKe","/UsersLogoutServlet"};
